import 'package:e_coomer/core/components/retry_widget.dart';
...
import 'package:e_coomer/fetures/metrics/presentation/view/widget/header_metrices_widget.dart';
import 'package:e_coomer/fetures/metrics/presentation/view/widget/iteam_order.dart';
                ...
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppStrings.order.tr,
                        style: TextStyles.f18600(context).copyWith(
                          color: Colors.black,
                        ),
                      ),
                      SizedBox(height: 16.h),
